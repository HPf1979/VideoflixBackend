...
Generated by 'django-admin startproject' using Django 4.2.For more information on this file, see
...
SECRET_KEY = 'django-insecure-d$)gl5)u_dfwyur*y1cr@2ak_zps0)c-_qm#!&7f)&8-%b=lr@'
...
CORS_ALLOWED_ORIGINS = [
    "https://herlina-pfeiffer.developerakademie.net",
    "http://localhost:4200",
    "http://127.0.0.1:4200",]
